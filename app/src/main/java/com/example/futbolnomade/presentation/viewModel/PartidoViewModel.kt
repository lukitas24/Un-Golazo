    ...
    fun crearPartido(
        ...
        viewModelScope.launch {
            try {
                ...
                Log.e("NOTIFICACION_CHECK", "Error creando partido", e)
            }
        }
    }
            ...
            try {
                ...
                if (exito && partido != null) {
                    ...
                    if (destinatarioUid != usuarioUid) {
                        val esUltimoCupo = partido.participantesActuales + 1 >= partido.participantesMaximos
                        
                        val titulo = if (esUltimoCupo) "¡Partido Completo! ⚽🔥" else "Nuevo jugador en tu partido ⚽"
                        val mensaje = if (esUltimoCupo) 
                            "$usuario se anotó. ¡Tu partido \"${partido.titulo}\" ya está lleno!" 
                            else "$usuario se anotó a \"${partido.titulo}\"."

                        Log.i("NOTIFICACION_CHECK", "🏃 Jugador se anotó. Notificando al creador ($destinatarioEmail)... Full: $esUltimoCupo")
                        ...
                        notificationSender.enviarNotificacionAUsuario(
                            ...
                            mensaje = mensaje,
                            data = mapOf(
                                "tipo" to if (esUltimoCupo) "PARTIDO_LLENO" else "NUEVO_JUGADOR",
                ...
                Log.e("NOTIFICACION_CHECK", "Error al anotarse", e)
            }
        }
    }
        ...
        viewModelScope.launch {
            try {
                ...
                if (exito && partido != null) {
                    ...
                    if (destinatarioUid != usuarioUid) {
                        Log.i("NOTIFICACION_CHECK", "🏃 Un jugador se bajó. Notificando al creador...")
                ...
                Log.e("NOTIFICACION_CHECK", "Error al cancelar inscripción", e)
            }
        }
    }
    ...
    fun eliminarJugador(context: Context, partidoId: String, jugadorAEliminar: String, usuarioSolicitante: String) {
        viewModelScope.launch {
            try {
                ...
                if (exito && partido != null) {
                    Log.i("NOTIFICACION_CHECK", "🚫 Jugador expulsado. Notificando...")
                    notificationSender.enviarNotificacionAUsuario(
                        context = context,
                        uid = uidExpulsado,
                ...
                Log.e("NOTIFICACION_CHECK", "Error al eliminar jugador", e)
            }
        }
    }
    ...
    fun actualizarEstadoPartido(partidoId: String, nuevoEstado: EstadoPartido) {
        viewModelScope.launch {
            try {
                ...
                Log.e("NOTIFICACION_CHECK", "Error actualizando estado partido", e)
            }
        }
    }
            ...
            try {
                ...
                if (partidoAntes != null) {
                    ...
                    if (cambios.isNotEmpty()) {
                        ...
                        Log.i("NOTIFICACION_CHECK", "⚙️ Partido modificado. Notificando participantes...")
                ...
                Log.e("NOTIFICACION_CHECK", "Error actualizando partido", e)
            }
        }
    }
        ...
        viewModelScope.launch {
            try {
                ...
                if (partido != null) {
                    ...
                    Log.i("NOTIFICACION_CHECK", "🗑️ Partido eliminado. Notificando participantes...")
                ...
                Log.e("NOTIFICACION_CHECK", "Error eliminando partido", e)
            }
        }
    }
}
